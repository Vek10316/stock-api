CREATE TABLE purchases_transactions_details (
	...
	CONSTRAINT fk_purchases_details_transact_id
	FOREIGN KEY (transact_id) REFERENCES purchases_transactions (transact_id)
	ON UPDATE CASCADE
	ON DELETE CASCADE,
	CONSTRAINT fk_purchases_details_stock_id
